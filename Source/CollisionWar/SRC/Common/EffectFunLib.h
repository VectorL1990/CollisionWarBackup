...
#include "../Game/Character/FoundationCharacter.h"
...
public:
	...
	*/
	...
	/************************************************************************/
	/* FoundationCharacter关于生产经营效果函数
	/************************************************************************/

	/** 提高玩家恢复速度
	*/
	static void PromotePlayerRecoverRate(FIntrinsicEffectInfo& effectInfo, ABaseCharacter* pLaunchCharacter);

	static void PromotePlayerRecoverRate_End(FIntrinsicEffectInfo& effectInfo, ABaseCharacter* pLaunchCharacter);
