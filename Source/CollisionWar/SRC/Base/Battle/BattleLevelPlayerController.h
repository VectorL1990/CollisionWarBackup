...
#include "../Widget/DialogTextMenu.h"
#include "../../Game/Character/FCDetecter.h"
...
public:
	...
	*/
	...
	bool CheckWhetherAbleToBuild(FVector cursorLoc, int32 occupyRadius);

	UFUNCTION(BlueprintCallable, Category = "CollisionWar")
	void LaunchSwitchViewTarget(float deltaT);
	...
	TSubclassOf<class AActor> m_occupyInfoActorClass;

	UPROPERTY()
	AFCDetecter* m_pOccupyInfoActor;
