...
#include "../../Character/FoundationCharacter.h"
...
public:	
	...
	void SpawnEventEffect(const FEffectParams& effectParam, uint8 exertType, FString eventName, AFoundationCharacter* pFC);
