...
public:
	...
	ABaseCharacter* FindFoundationCharacterEntity(int32 entityID);
	...
	UPROPERTY(BlueprintReadWrite, Category = "CollisionWar/Game")
	TArray<AFoundationCharacter*> m_pFoundationCharacters;

	UPROPERTY(BlueprintReadWrite, Category = "CollisionWar/Game")
	TArray<ABaseCharacter*> m_pDeadCharacters;

	UPROPERTY(BlueprintReadWrite, Category = "CollisionWar/Game")
	ABaseCharacter* m_pRogueSpecifiedTarget;
	...
	virtual void CollectIntrinsicEffectInfos(AFoundationCharacter* pCharacter);

	virtual void RemoveIntrinsicEffectInfos(AFoundationCharacter* pCharacter);

	void RecoverPlayerPerInterval();

	virtual bool CheckResourceAmoutToBuild(int32 spellNb);

	virtual void SubtractFCConstructResources(int32 FCNb);

	virtual void SpawnConstructionSite(int32 FCNb);
