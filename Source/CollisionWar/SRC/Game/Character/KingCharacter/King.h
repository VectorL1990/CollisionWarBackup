...
public:
	...
	void ImplementCounterStrikeSkill();

	void ImplementAbsortSkill();
	...
	UPROPERTY()
	UBaseSkill* m_pCounterStrikeSkill;

	UPROPERTY()
	UBaseSkill* m_pBlockSkill;

	UPROPERTY()
	UBaseSkill* m_pAbsortSkill;

	UPROPERTY()
	TSubclassOf<class AFoundationCharacter> m_waitToSpawnFoundationCharacter;

	UPROPERTY()
	UBaseSkill* m_pCSSkill;
